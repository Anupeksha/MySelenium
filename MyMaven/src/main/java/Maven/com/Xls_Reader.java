...
public class Xls_Reader {
	...
	public String getCellData(String sheetName,String colName,int rowNum, DateUtil XSSFDateUtil){
		try{
			if(rowNum <=0)
				return "";
		...
		if(cell.getCellType()==CellType.STRING)
			  ...
			  if (XSSFDateUtil.isCellDateFormatted(cell)) {
				  ...
				  cal.setTime(XSSFDateUtil.getJavaDate(d));
		            cellText =
...
//		style.setFillBackgroundColor(XSSFColor.from(color, map))
//		style.setFillBackgroundColor(HSSFColor.HSSFColorPredefined.CORNFLOWER_BLUE);
